...
<html lang="en">
  ...
  <body>
  <header class="bg-danger text-white text-center py-5 mt-5">
  <img src="logo.png" alt="O Positive Logo" class="mb-4" style="max-width: 150px;">

    <h1 class="display-4">O Positive</h1>
